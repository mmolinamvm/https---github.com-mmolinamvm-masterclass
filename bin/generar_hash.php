...
echo "UPDATE mc_usuaris SET password_hash = '{$hash_alumne}' WHERE email = 'alumne@masterclass.com';\n\n";

$hash_profe = password_hash('profe123', PASSWORD_BCRYPT);
echo "UPDATE mc_usuaris SET password_hash = '{$hash_profe}' WHERE email = 'profe@masterclass.com';\n";